...
PROJECT_DIR = os.path.abspath(os.path.join(HERE, '..', '..', '..'))  # husky_assembly
if not os.path.isdir(PROJECT_DIR):
    raise FileNotFoundError(f"Parent PROJECT_DIR does not exist: {PROJECT_DIR}")
EXT_DIR = os.path.join(PROJECT_DIR, "external")  # ext
