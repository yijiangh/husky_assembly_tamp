...
class DualArmProjection:
    ...
    def __init__(self, robot_setup: RobotSetup, desired_right_from_left: Tuple):
        self.robot_setup: RobotSetup = robot_setup
    ...
    def project_multiple(self, right: np.ndarray, max_attempts: int = 100, collision_fn: Callable[[np.ndarray], bool] = None) -> Union[np.ndarray, None]:
        ...
        Args:
            right: Right arm joint angles
            max_attempts: Maximum number of attempts to find valid configurations
            collision_fn: Optional collision function to filter out invalid configurations
...
if __name__ == "__main__":
    ...
    target_conf = np.array([2.22637564e-03, -3.51527382e-01, 1.42532484e00, -2.30987362e00, 1.78120551e00, -1.55214616e00, 5.17115363e-01, -1.11289822e00, -7.18635362e-01, 2.17292434e00, -1.29150914e00, 1.42157927e00])
