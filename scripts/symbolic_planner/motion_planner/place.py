...
def compute_place_path(
    ...
    obstacles: Set[int],
    base_pose_sampler: Callable[[Callable[[np.ndarray, bool], bool]], Tuple[np.ndarray, float]],
    ...
    """
    Compute place path (mobile manipulator conf): attach_pose (goal_pose) --> home_pose.
    ...
    Params:
        ...
        base_pose_sampler (function): [collision_fn] --> Tuple[np.ndarray, float] ([x, y, z], yaw)
    ...
    for _ in range(max_attempt):
        ...
        robot_base_collision_fn = pp.get_collision_fn(
            robot_setup.robot,
        ...
        base_pose_tup = base_pose_sampler(collision_fn=robot_base_collision_fn)
        ...
        command = pre_attach_confs
        mask = [True] * len(pre_attach_confs)
...
def get_place_gen_fn(
    ...
    Params:
        ...
        max_attempts (int, 50): attempts to generate place motion
    ...
    def gen_fn(
        ...
        for attempt in range(max_attempts):
            ...
            TermPrint.print("Place E#{} | Attempts: {} | Command: {}".format(index, attempt, len(command)), "green")
        ...
        # -------------------- fail --------------------#
        TermPrint.print("Place E#{} | Attempts: {} | Max attempts exceeded!".format(index, max_attempts), "red")
