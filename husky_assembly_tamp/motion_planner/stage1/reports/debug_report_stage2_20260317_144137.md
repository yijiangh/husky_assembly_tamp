# Stage 2 Debugging Report (20260317_144137)

## Scope

This report summarizes results from:

- `_support/failure_analysis_stage2_20260317_144137.json`
- `_support/failure_analysis_stage2_20260317_144137.csv`
- `_support/failure_distribution_stage2_20260317_144137.png`
- `_support/stage2_success_20260317_144137.png`
- `_support/runtime_by_seed_stage2_20260317_144137.png`
- `_support/tree_structure_stage2_seed0_20260317_144137.png`
- `_support/trajectory_validation_stage2_20260317_144142.png`
- `_support/planner_breakdown_stage2_20260317_144137.png`
- `_support/plan_profile_stage2_seed0_20260317_144137.txt`
...
![Trajectory Validation](_support/trajectory_validation_stage2_20260317_144142.png)
...
### Distribution plot
![Failure Distribution](_support/failure_distribution_stage2_20260317_144137.png)
...
![Stage 2 Success Rate](_support/stage2_success_20260317_144137.png)

### Runtime-by-seed plot
![Runtime by Seed](_support/runtime_by_seed_stage2_20260317_144137.png)

### Planner breakdown plot
![Planner Breakdown](_support/planner_breakdown_stage2_20260317_144137.png)

From `summary`:

- Stage 2 validated success rate: **20%**
- Stage 2 task-space path-found rate: **100%**
- Stage 2 avg runtime: **5.754 s**
- Stage 2 avg iterations: **107.8**
- Stage 2 avg nodes created: **1789.4**
- Stage 2 avg poses checked: **1889.4**
- Stage 2 avg IK calls: **3874.8**
- Stage 2 avg IK failures: **193.2**
- Stage 2 avg max dq: **0.1467 rad**

Detailed `cProfile` summary: `_support/plan_profile_stage2_seed0_20260317_144137.txt`
