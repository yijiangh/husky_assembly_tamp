# Stage 3 Debugging Report (20260317_133407)

## Scope

This report summarizes results from:

- `_support/failure_analysis_stage3_20260317_133407.json`
- `_support/failure_analysis_stage3_20260317_133407.csv`
- `_support/failure_distribution_stage3_20260317_133407.png`
- `_support/stage3_success_20260317_133407.png`
- `_support/runtime_by_seed_stage3_20260317_133407.png`
- `_support/tree_structure_stage3_seed0_20260317_133407.png`
- `_support/trajectory_validation_stage3_20260317_133428.png`
- `_support/planner_breakdown_stage3_20260317_133407.png`
- `_support/plan_profile_stage3_seed0_20260317_133407.txt`
...
![Trajectory Validation](_support/trajectory_validation_stage3_20260317_133428.png)
...
### Distribution plot
![Failure Distribution](_support/failure_distribution_stage3_20260317_133407.png)
...
![Stage 3 Success Rate](_support/stage3_success_20260317_133407.png)

### Runtime-by-seed plot
![Runtime by Seed](_support/runtime_by_seed_stage3_20260317_133407.png)

### Planner breakdown plot
![Planner Breakdown](_support/planner_breakdown_stage3_20260317_133407.png)

From `summary`:

- Stage 3 validated success rate: **100%**
- Stage 3 task-space path-found rate: **100%**
- Stage 3 avg runtime: **1.782 s**
...
- Stage 3 avg max dq: **0.1399 -> 0.1399 rad**
- Stage 3 avg collision hits: **33.6**

Detailed `cProfile` summary: `_support/plan_profile_stage3_seed0_20260317_133407.txt`
